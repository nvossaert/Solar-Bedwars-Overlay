...
function panelLog(p) {
  ...
  p.appendChild(fieldRow('Track anyone who talks in chat', 'Add any player who speaks in chat to the list while you’re actually in a Bedwars lobby/game (never in the main hub). Off by default - even scoped to Bedwars, not everyone wants every lobby chatter added.', toggle('trackChatSpeakers')));
}
